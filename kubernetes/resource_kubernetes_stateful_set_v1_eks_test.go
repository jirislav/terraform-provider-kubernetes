...
func TestAccKubernetesStatefulSetV1_EKS_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccKubernetesStatefulSetV1ConfigBasicEks(name, imageName),
...
func TestAccKubernetesStatefulSetV1_EKS_basic_idempotency(t *testing.T) {
	var conf appsv1.StatefulSet
	name := fmt.Sprintf("tf-acc-test-%s", acctest.RandStringFromCharSet(10, acctest.CharSetAlphaNum))
	resourceName := "kubernetes_stateful_set_v1.test"
	imageName := agnhostImage
...
func TestAccKubernetesStatefulSetV1_EKS_Update(t *testing.T) {
	var conf appsv1.StatefulSet
	name := fmt.Sprintf("tf-acc-test-%s", acctest.RandStringFromCharSet(10, acctest.CharSetAlphaNum))
	resourceName := "kubernetes_stateful_set_v1.test"
	imageName := agnhostImage
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccKubernetesStatefulSetV1ConfigMinimalEks(name, imageName),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckKubernetesStatefulSetV1Exists(resourceName, &conf),
				),
			},
			{
				Config: testAccKubernetesStatefulSetV1ConfigUpdateImageEks(name, imageName),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckKubernetesStatefulSetV1Exists(resourceName, &conf),
					resource.TestCheckResourceAttr(resourceName, "spec.0.template.0.spec.0.container.0.image", imageName),
				),
			...
			{
				Config: testAccKubernetesStatefulSetV1ConfigUpdatedSelectorLabelsEks(name, imageName),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckKubernetesStatefulSetV1Exists(resourceName, &conf),
			...
			{
				Config: testAccKubernetesStatefulSetV1ConfigUpdateReplicasEks(name, imageName, "3"),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckKubernetesStatefulSetV1Exists(resourceName, &conf),
					resource.TestCheckResourceAttr(resourceName, "metadata.0.name", name),
			...
			{
				Config: testAccKubernetesStatefulSetV1ConfigUpdateReplicasEks(name, imageName, ""),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckKubernetesStatefulSetV1Exists(resourceName, &conf),
					resource.TestCheckResourceAttr(resourceName, "metadata.0.name", name),
			...
			{
				Config: testAccKubernetesStatefulSetV1ConfigUpdateReplicasEks(name, imageName, "0"),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckKubernetesStatefulSetV1Exists(resourceName, &conf),
					resource.TestCheckResourceAttr(resourceName, "metadata.0.name", name),
			...
			{
				Config: testAccKubernetesStatefulSetV1ConfigUpdateMinReadySecondsEks(name, imageName, 10),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckKubernetesStatefulSetV1Exists(resourceName, &conf),
					resource.TestCheckResourceAttr(resourceName, "metadata.0.name", name),
					resource.TestCheckResourceAttr(resourceName, "spec.0.min_ready_seconds", "10"),
			...
			{
				Config: testAccKubernetesStatefulSetV1ConfigUpdateMinReadySecondsEks(name, imageName, 0),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckKubernetesStatefulSetV1Exists(resourceName, &conf),
					resource.TestCheckResourceAttr(resourceName, "metadata.0.name", name),
			...
			{
				Config: testAccKubernetesStatefulSetV1ConfigRollingUpdatePartitionEks(name, imageName),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckKubernetesStatefulSetV1Exists(resourceName, &conf),
					resource.TestCheckResourceAttr(resourceName, "metadata.0.name", name),
			...
			{
				Config: testAccKubernetesStatefulSetV1ConfigUpdateStrategyOnDeleteEks(name, imageName),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckKubernetesStatefulSetV1Exists(resourceName, &conf),
					resource.TestCheckResourceAttr(resourceName, "metadata.0.name", name),
			...
			{
				Config: testAccKubernetesStatefulSetV1ConfigUpdateTemplateEks(name, imageName),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckKubernetesStatefulSetV1Exists(resourceName, &conf),
					resource.TestCheckResourceAttr(resourceName, "metadata.0.name", name),
			...
			{
				Config: testAccKubernetesStatefulSetV1ConfigUpdatePersistentVolumeClaimRetentionPolicyEks(name, imageName),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckKubernetesStatefulSetV1Exists(resourceName, &conf),
					resource.TestCheckResourceAttr(resourceName, "metadata.0.name", name),
...
func TestAccKubernetesStatefulSetV1_EKS_waitForRollout(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccKubernetesStatefulSetV1ConfigWaitForRolloutEks(name, imageName, "true"),
				Check: resource.ComposeAggregateTestCheckFunc(
			...
			{
				Config: testAccKubernetesStatefulSetV1ConfigWaitForRolloutEks(name, imageName1, "false"),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func testAccKubernetesStatefulSetV1ConfigMinimalEks(name, imageName string) string {
...
func testAccKubernetesStatefulSetV1ConfigBasicEks(name, imageName string) string {
	return fmt.Sprintf(`resource "kubernetes_stateful_set_v1" "test" {
  metadata {
    annotations = {
...
func testAccKubernetesStatefulSetV1ConfigUpdateImageEks(name, imageName string) string {
	return fmt.Sprintf(`resource "kubernetes_stateful_set_v1" "test" {
  metadata {
    annotations = {
      TestAnnotationOne = "one"
...
func testAccKubernetesStatefulSetV1ConfigUpdatedSelectorLabelsEks(name, imageName string) string {
	return fmt.Sprintf(`resource "kubernetes_stateful_set_v1" "test" {
  metadata {
    annotations = {
      TestAnnotationOne = "one"
...
func testAccKubernetesStatefulSetV1ConfigUpdateReplicasEks(name, imageName, replicas string) string {
	return fmt.Sprintf(`resource "kubernetes_stateful_set_v1" "test" {
  metadata {
    annotations = {
      TestAnnotationOne = "one"
...
func testAccKubernetesStatefulSetV1ConfigUpdateMinReadySecondsEks(name string, imageName string, minReadySeconds int) string {
	return fmt.Sprintf(`resource "kubernetes_stateful_set_v1" "test" {
  metadata {
    annotations = {
      TestAnnotationOne = "one"
...
func testAccKubernetesStatefulSetV1ConfigUpdateTemplateEks(name, imageName string) string {
	return fmt.Sprintf(`resource "kubernetes_stateful_set_v1" "test" {
  metadata {
    annotations = {
      TestAnnotationOne = "one"
...
func testAccKubernetesStatefulSetV1ConfigRollingUpdatePartitionEks(name, imageName string) string {
	return fmt.Sprintf(`resource "kubernetes_stateful_set_v1" "test" {
  metadata {
    annotations = {
      TestAnnotationOne = "one"
...
func testAccKubernetesStatefulSetV1ConfigUpdateStrategyOnDeleteEks(name, imageName string) string {
	return fmt.Sprintf(`resource "kubernetes_stateful_set_v1" "test" {
  metadata {
    annotations = {
      TestAnnotationOne = "one"
...
func testAccKubernetesStatefulSetV1ConfigWaitForRolloutEks(name, imageName, waitForRollout string) string {
	return fmt.Sprintf(`resource "kubernetes_stateful_set_v1" "test" {
  metadata {
    name = "%s"
  }
...
func testAccKubernetesStatefulSetV1ConfigUpdatePersistentVolumeClaimRetentionPolicyEks(name, imageName string) string {
	return fmt.Sprintf(`resource "kubernetes_stateful_set_v1" "test" {
  metadata {
    annotations = {
      TestAnnotationOne = "one"
